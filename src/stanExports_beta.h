...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 225, column 4 to column 105)",
                                                      " (in 'string', line 226, column 4 to column 110)",
                                                      ...
                                                      " (in 'string', line 242, column 4 to column 52)",
                                                      " (in 'string', line 243, column 4 to column 52)",
...
public:
  ...
  inline std::string model_name() const final { return "model_beta"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-4-gd72b68b7-dirty", "stancflags = "};
  }
  
  
  model_beta(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_beta_namespace::model_beta";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_beta_namespace::log_prob";
(void) function__;  // suppress unused var warning
    ...
    try {
      ...
      for (int i = 1; i <= 2; ++i) {
        ...
        assign(alpha_i, cons_list(index_uni(i), nil_index_list()),
          (-(mu_i[(i - 1)] *
              ((pow(mu_i[(i - 1)], 2) - mu_i[(i - 1)]) +
                pow(sigma_i[(i - 1)], 2))) / pow(sigma_i[(i - 1)], 2)),
          ...
          "assigning variable beta_i");}
      {
        ...
        if (logical_eq(is_ss, 0)) {
          ...
          lp_accum__.add(
            beta_lpdf<false>(x1, alpha_i[(1 - 1)], beta_i[(1 - 1)]));
          current_statement__ = 41;
          lp_accum__.add(
            beta_lpdf<false>(x2, alpha_i[(2 - 1)], beta_i[(2 - 1)]));
        } else {
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_beta_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
