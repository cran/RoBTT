...
static constexpr std::array<const char*, 231> locations_array__ =
  ...
  " (in 'string', line 251, column 4 to column 105)",
  " (in 'string', line 252, column 4 to column 110)",
  ...
  " (in 'string', line 268, column 4 to column 52)",
  " (in 'string', line 269, column 4 to column 52)",
    ...
    try {
      ...
      }
      {
        ...
        if (stan::math::logical_eq(is_ss, 0)) {
          ...
          lp_accum__.add(stan::math::beta_lpdf<false>(x1,
                           stan::model::rvalue(alpha_i, "alpha_i",
                             stan::model::index_uni(1)),
                           stan::model::rvalue(beta_i, "beta_i",
                             stan::model::index_uni(1))));
          current_statement__ = 41;
          lp_accum__.add(stan::math::beta_lpdf<false>(x2,
                           stan::model::rvalue(alpha_i, "alpha_i",
                             stan::model::index_uni(2)),
                           stan::model::rvalue(beta_i, "beta_i",
                             stan::model::index_uni(2))));
