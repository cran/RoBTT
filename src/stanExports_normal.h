...
static constexpr std::array<const char*, 243> locations_array__ =
  ...
  " (in 'string', line 237, column 2 to column 109)",
  " (in 'string', line 238, column 2 to column 120)",
  " (in 'string', line 239, column 2 to column 111)",
  " (in 'string', line 240, column 2 to column 109)",
  " (in 'string', line 243, column 2 to column 20)",
  " (in 'string', line 244, column 2 to column 20)",
  " (in 'string', line 245, column 2 to column 17)",
  " (in 'string', line 252, column 4 to column 66)",
  " (in 'string', line 253, column 4 to column 66)",
  " (in 'string', line 254, column 4 to column 62)",
  " (in 'string', line 251, column 7 to line 255, column 3)",
  " (in 'string', line 248, column 4 to column 62)",
  " (in 'string', line 249, column 4 to column 62)",
  " (in 'string', line 250, column 4 to column 62)",
  " (in 'string', line 247, column 15 to line 251, column 3)",
  " (in 'string', line 247, column 2 to line 255, column 3)",
  " (in 'string', line 260, column 4 to column 51)",
  " (in 'string', line 261, column 4 to column 51)",
  " (in 'string', line 259, column 7 to line 262, column 3)",
  " (in 'string', line 257, column 4 to column 49)",
  " (in 'string', line 258, column 4 to column 49)",
  " (in 'string', line 256, column 15 to line 259, column 3)",
  " (in 'string', line 256, column 2 to line 262, column 3)",
  " (in 'string', line 266, column 2 to column 105)",
  " (in 'string', line 267, column 2 to column 109)",
  " (in 'string', line 271, column 4 to column 93)",
  " (in 'string', line 270, column 15 to line 272, column 3)",
  " (in 'string', line 270, column 2 to line 272, column 3)",
  " (in 'string', line 274, column 4 to column 91)",
  " (in 'string', line 273, column 15 to line 275, column 3)",
  " (in 'string', line 273, column 2 to line 275, column 3)",
  " (in 'string', line 281, column 4 to column 154)",
  " (in 'string', line 282, column 4 to column 154)",
  " (in 'string', line 280, column 7 to line 283, column 3)",
  " (in 'string', line 278, column 4 to column 52)",
  " (in 'string', line 279, column 4 to column 52)",
  " (in 'string', line 277, column 16 to line 280, column 3)",
  " (in 'string', line 277, column 2 to line 283, column 3)",
  " (in 'string', line 287, column 4 to column 125)",
  " (in 'string', line 288, column 4 to column 125)",
  " (in 'string', line 286, column 19 to line 289, column 3)",
  " (in 'string', line 286, column 2 to line 289, column 3)",
  ...
  " (in 'string', line 217, column 2 to column 26)",
  " (in 'string', line 218, column 9 to column 26)",
  " (in 'string', line 218, column 2 to column 37)",
  " (in 'string', line 219, column 9 to column 26)",
  " (in 'string', line 219, column 2 to column 37)",
  " (in 'string', line 220, column 2 to column 30)",
  " (in 'string', line 221, column 2 to column 34)",
  " (in 'string', line 222, column 8 to column 25)",
  " (in 'string', line 222, column 2 to column 45)",
  " (in 'string', line 223, column 8 to column 25)",
  " (in 'string', line 223, column 2 to column 45)",
  " (in 'string', line 225, column 9 to column 26)",
  " (in 'string', line 225, column 2 to column 36)",
  " (in 'string', line 226, column 9 to column 26)",
  " (in 'string', line 226, column 2 to column 36)",
  " (in 'string', line 227, column 2 to column 32)",
  " (in 'string', line 228, column 2 to column 36)",
  " (in 'string', line 229, column 9 to column 26)",
  " (in 'string', line 229, column 2 to column 47)",
  " (in 'string', line 230, column 9 to column 26)",
  " (in 'string', line 230, column 2 to column 47)",
  " (in 'string', line 231, column 2 to column 20)",
  " (in 'string', line 232, column 2 to column 24)",
  " (in 'string', line 233, column 2 to column 19)",
  " (in 'string', line 234, column 2 to column 19)",
  " (in 'string', line 239, column 8 to column 12)",
  " (in 'string', line 240, column 8 to column 12)",
...
public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      sigma2 = in__.template read_constrain_lub<local_scalar_t__,
                 jacobian__>(coefs_lb(bounds_type_sigma2, bounds_sigma2,
                               pstream__),
                 coefs_ub(bounds_type_sigma2, bounds_sigma2, pstream__),
                 lp__);
      ...
      }
      {
        ...
        if (stan::math::logical_eq(is_ss, 0)) {
          ...
          lp_accum__.add(stan::math::normal_lpdf<false>(x1,
                           stan::model::rvalue(mu_i, "mu_i",
                             stan::model::index_uni(1)),
                           stan::model::rvalue(sigma_i, "sigma_i",
                             stan::model::index_uni(1))));
          current_statement__ = 36;
          lp_accum__.add(stan::math::normal_lpdf<false>(x2,
                           stan::model::rvalue(mu_i, "mu_i",
                             stan::model::index_uni(2)),
                           stan::model::rvalue(sigma_i, "sigma_i",
                             stan::model::index_uni(2))));
          ...
          lp_accum__.add((((-N1 / 2.0) *
            stan::math::log(((2 * stan::math::pi()) *
              stan::math::pow(
                stan::model::rvalue(sigma_i, "sigma_i",
                  stan::model::index_uni(1)), 2)))) - ((1 / (2 *
            stan::math::pow(
              stan::model::rvalue(sigma_i, "sigma_i",
                stan::model::index_uni(1)), 2))) * (((N1 - 1) *
            stan::math::pow(
              stan::model::rvalue(sd_i, "sd_i", stan::model::index_uni(1)), 2))
            + (N1 *
            stan::math::pow(
              (stan::model::rvalue(mean_i, "mean_i",
                 stan::model::index_uni(1)) -
              stan::model::rvalue(mu_i, "mu_i", stan::model::index_uni(1))),
              2))))));
          current_statement__ = 33;
          lp_accum__.add((((-N2 / 2.0) *
            stan::math::log(((2 * stan::math::pi()) *
              stan::math::pow(
                stan::model::rvalue(sigma_i, "sigma_i",
                  stan::model::index_uni(2)), 2)))) - ((1 / (2 *
            stan::math::pow(
              stan::model::rvalue(sigma_i, "sigma_i",
                stan::model::index_uni(2)), 2))) * (((N2 - 1) *
            stan::math::pow(
              stan::model::rvalue(sd_i, "sd_i", stan::model::index_uni(2)), 2))
            + (N2 *
            stan::math::pow(
              (stan::model::rvalue(mean_i, "mean_i",
                 stan::model::index_uni(2)) -
  ...
  unconstrain_array_impl(const VecVar& params_r__, const VecI& params_i__,
    ...
    try {
      ...
      out__.write_free_lub(coefs_lb(bounds_type_sigma2, bounds_sigma2,
                             pstream__),
        coefs_ub(bounds_type_sigma2, bounds_sigma2, pstream__), sigma2);
      std::vector<local_scalar_t__> delta =
        std::vector<local_scalar_t__>(is_d, DUMMY_VAR__);
      current_statement__ = 3;
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"pooled_sigma", "sigma_i", "mu_i"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma2\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(is_d) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(is_r) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"pooled_sigma\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"sigma_i\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"mu_i\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"}]");
  }
