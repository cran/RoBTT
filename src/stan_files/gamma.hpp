...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(148, 1, "restart", "model_gamma");
    reader.add_event(240, 91, "end", "model_gamma");
    return reader;
}
        ...
        try {
            ...
            for (int i = 1; i <= 2; ++i) {
                ...
                stan::model::assign(alpha_i, 
                            ...
                            (pow(get_base1(mu_i, i, "mu_i", 1), 2) / pow(get_base1(sigma_i, i, "sigma_i", 1), 2)), 
                            "assigning variable alpha_i");
                current_statement_begin__ = 215;
                stan::model::assign(beta_i, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(mu_i, i, "mu_i", 1) / pow(get_base1(sigma_i, i, "sigma_i", 1), 2)), 
            ...
            if (as_bool(logical_eq(is_ss, 0))) {
                ...
                lp_accum__.add(gamma_log(x1, get_base1(alpha_i, 1, "alpha_i", 1), get_base1(beta_i, 1, "beta_i", 1)));
                current_statement_begin__ = 234;
                lp_accum__.add(gamma_log(x2, get_base1(alpha_i, 2, "alpha_i", 1), get_base1(beta_i, 2, "beta_i", 1)));
            } else {
