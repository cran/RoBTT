...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(148, 1, "restart", "model_t");
    reader.add_event(256, 107, "end", "model_t");
    return reader;
}
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        for (size_t i_0__ = 0; i_0__ < nu_p_i_0_max__; ++i_0__) {
            try {
                writer__.scalar_lub_unconstrain(coefs_lb(get_base1(bounds_type_nu, 1, "bounds_type_nu", 1), get_base1(bounds_nu, 1, "bounds_nu", 1), pstream__), coefs_ub(get_base1(bounds_type_nu, 2, "bounds_type_nu", 1), get_base1(bounds_nu, 2, "bounds_nu", 1), pstream__), nu_p[i_0__]);
            } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (size_t d_0__ = 0; d_0__ < nu_p_d_0_max__; ++d_0__) {
                if (jacobian__)
                    nu_p.push_back(in__.scalar_lub_constrain(coefs_lb(get_base1(bounds_type_nu, 1, "bounds_type_nu", 1), get_base1(bounds_nu, 1, "bounds_nu", 1), pstream__), coefs_ub(get_base1(bounds_type_nu, 2, "bounds_type_nu", 1), get_base1(bounds_nu, 2, "bounds_nu", 1), pstream__), lp__));
                else
                    nu_p.push_back(in__.scalar_lub_constrain(coefs_lb(get_base1(bounds_type_nu, 1, "bounds_type_nu", 1), get_base1(bounds_nu, 1, "bounds_nu", 1), pstream__), coefs_ub(get_base1(bounds_type_nu, 2, "bounds_type_nu", 1), get_base1(bounds_nu, 2, "bounds_nu", 1), pstream__)));
            }
