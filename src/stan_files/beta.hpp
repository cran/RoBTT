...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_beta");
    ...
    reader.add_event(148, 1, "restart", "model_beta");
    reader.add_event(240, 91, "end", "model_beta");
    return reader;
}
...
class model_beta
  : public stan::model::model_base_crtp<model_beta> {
private:
        int is_ss;
        int N1;
        int N2;
...
public:
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        mu = vals_r__[pos__++];
        try {
            writer__.scalar_lub_unconstrain(0, 1, mu);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                mu = in__.scalar_lub_constrain(0, 1, lp__);
            else
                mu = in__.scalar_lub_constrain(0, 1);
            ...
            validate_non_negative_index("alpha_i", "2", 2);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> alpha_i(2);
            stan::math::initialize(alpha_i, DUMMY_VAR__);
            stan::math::fill(alpha_i, DUMMY_VAR__);

            current_statement_begin__ = 193;
            validate_non_negative_index("beta_i", "2", 2);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> beta_i(2);
            stan::math::initialize(beta_i, DUMMY_VAR__);
            ...
            for (int i = 1; i <= 2; ++i) {
                ...
                stan::model::assign(alpha_i, 
                            ...
                            (-((get_base1(mu_i, i, "mu_i", 1) * ((pow(get_base1(mu_i, i, "mu_i", 1), 2) - get_base1(mu_i, i, "mu_i", 1)) + pow(get_base1(sigma_i, i, "sigma_i", 1), 2)))) / pow(get_base1(sigma_i, i, "sigma_i", 1), 2)), 
                            "assigning variable alpha_i");
                current_statement_begin__ = 215;
                stan::model::assign(beta_i, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (((get_base1(mu_i, i, "mu_i", 1) - 1) * ((pow(get_base1(mu_i, i, "mu_i", 1), 2) - get_base1(mu_i, i, "mu_i", 1)) + pow(get_base1(sigma_i, i, "sigma_i", 1), 2))) / pow(get_base1(sigma_i, i, "sigma_i", 1), 2)), 
            ...
            current_statement_begin__ = 192;
            size_t alpha_i_j_1_max__ = 2;
            for (size_t j_1__ = 0; j_1__ < alpha_i_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(alpha_i(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: alpha_i" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable alpha_i: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 193;
            size_t beta_i_j_1_max__ = 2;
            for (size_t j_1__ = 0; j_1__ < beta_i_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(beta_i(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: beta_i" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable beta_i: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            ...
            if (as_bool(logical_eq(is_ss, 0))) {
                ...
                lp_accum__.add(beta_log(x1, get_base1(alpha_i, 1, "alpha_i", 1), get_base1(beta_i, 1, "beta_i", 1)));
                current_statement_begin__ = 234;
                lp_accum__.add(beta_log(x2, get_base1(alpha_i, 2, "alpha_i", 1), get_base1(beta_i, 2, "beta_i", 1)));
            } else {
    ...
    void write_array(RNG& base_rng__,
        ...
        double mu = in__.scalar_lub_constrain(0, 1);
        vars__.push_back(mu);
        ...
        try {
            ...
            current_statement_begin__ = 192;
            validate_non_negative_index("alpha_i", "2", 2);
            Eigen::Matrix<double, Eigen::Dynamic, 1> alpha_i(2);
            stan::math::initialize(alpha_i, DUMMY_VAR__);
            stan::math::fill(alpha_i, DUMMY_VAR__);

            current_statement_begin__ = 193;
            validate_non_negative_index("beta_i", "2", 2);
            Eigen::Matrix<double, Eigen::Dynamic, 1> beta_i(2);
            stan::math::initialize(beta_i, DUMMY_VAR__);
            stan::math::fill(beta_i, DUMMY_VAR__);
            ...
            if (include_tparams__) {
                ...
                size_t alpha_i_j_1_max__ = 2;
                for (size_t j_1__ = 0; j_1__ < alpha_i_j_1_max__; ++j_1__) {
                    vars__.push_back(alpha_i(j_1__));
                }
                size_t beta_i_j_1_max__ = 2;
                for (size_t j_1__ = 0; j_1__ < beta_i_j_1_max__; ++j_1__) {
                    vars__.push_back(beta_i(j_1__));
                }
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t j_1__ = 0; j_1__ < alpha_i_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "alpha_i" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t beta_i_j_1_max__ = 2;
            for (size_t j_1__ = 0; j_1__ < beta_i_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "beta_i" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
...
typedef model_beta_namespace::model_beta stan_model;
