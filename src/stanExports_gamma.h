...
static constexpr std::array<const char*, 231> locations_array__ =
  ...
  " (in 'string', line 232, column 2 to column 19)",
  ...
  " (in 'string', line 251, column 4 to column 54)",
  " (in 'string', line 252, column 4 to column 46)",
  ...
  " (in 'string', line 268, column 4 to column 53)",
  " (in 'string', line 269, column 4 to column 53)",
...
public:
    ...
    try {
      ...
      for (int i = 1; i <= 2; ++i) {
        ...
        stan::model::assign(alpha_i,
          (stan::math::pow(
             stan::model::rvalue(mu_i, "mu_i", stan::model::index_uni(i)), 2)
          /
          stan::math::pow(
            stan::model::rvalue(sigma_i, "sigma_i", stan::model::index_uni(i)),
            2)), "assigning variable alpha_i", stan::model::index_uni(i));
        current_statement__ = 27;
        stan::model::assign(beta_i,
          (stan::model::rvalue(mu_i, "mu_i", stan::model::index_uni(i)) /
          stan::math::pow(
            stan::model::rvalue(sigma_i, "sigma_i", stan::model::index_uni(i)),
            2)), "assigning variable beta_i", stan::model::index_uni(i));
      }
      {
        ...
        if (stan::math::logical_eq(is_ss, 0)) {
          ...
          lp_accum__.add(stan::math::gamma_lpdf<false>(x1,
                           stan::model::rvalue(alpha_i, "alpha_i",
                             stan::model::index_uni(1)),
                           stan::model::rvalue(beta_i, "beta_i",
                             stan::model::index_uni(1))));
          current_statement__ = 41;
          lp_accum__.add(stan::math::gamma_lpdf<false>(x2,
                           stan::model::rvalue(alpha_i, "alpha_i",
                             stan::model::index_uni(2)),
                           stan::model::rvalue(beta_i, "beta_i",
                             stan::model::index_uni(2))));
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_transformed_parameters__) {
      std::vector<std::string>
        temp{"pooled_sigma", "mu_i", "sigma_i", "alpha_i", "beta_i"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"mu\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma2\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"delta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(is_d) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"rho\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(is_r) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"pooled_sigma\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"mu_i\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"sigma_i\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"alpha_i\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"},{\"name\":\"beta_i\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(2) + "},\"block\":\"transformed_parameters\"}]");
  }
